...
namespace MathCSharpDesktop
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCalculateRatio_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxUnitsRatio.SelectedItem.ToString() == "Fluid Ounces")
            {
            ...
            if (comboBoxUnitsRatio.SelectedItem.ToString() == "Milliliters")
            {
            ...
            if (comboBoxUnitsRatio.SelectedItem.ToString() == "US Legal Cups")
            {
                //Calculation for fluid ounce(oz)
            ...
            if (comboBoxUnitsRatio.SelectedItem.ToString() == "US Cups")
            {
                //Calculation for fluid ounce(oz)
